I need assistance in modifying a bot's functionality for a messaging platform (e.g., Discord, Telegram). Here are the detailed requirements:



1. **Auto-Delete Message in Group:**

   - Whenever a message containing the text `🚨 *QUESTION 1 IS LIVE!* 🚨` is posted in a specific group channel, the bot should automatically delete this message after it is posted.



2. **Channel Message with Button:**

   - In a designated channel, when the message `🚨 *QUESTION 3 IS LIVE!* 🚨` is posted, I would like this message to include a button.

   - The button should be labeled, for example, "Join Discussion Group" and should be programmed to direct users to a specific group link.



3. **Timer for Answering:**

   - The timer for responding to the question in the group discussion should be set according to the associated message:

     - The message for Question 1 indicates that users have **5 seconds** to answer.

     - The message for Question 3 indicates that users have **15 seconds** to answer.



4. **Post Correct Answer in Group:**

   - After the quiz question has been answered (or after the timer expires), the bot should post the correct answer in the group where the quiz was conducted.



5. **Additional Requirements:**

   - Ensure that the deletion of the message and the posting of the correct answer are executed smoothly without disrupting the user experience.

   - Log any errors the bot might encounter during these automated processes for debugging purposes.



By fulfilling these requirements, I aim to create an engaging quiz experience for users, enhancing interaction while keeping the chat organized.
